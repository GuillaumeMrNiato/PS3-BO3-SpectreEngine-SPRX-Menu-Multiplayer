...
enum Addr
{
 ...
 //G_Client = 0x18C42E8
 CG_BoldGameMessage_ = 0x011484, //1.07
 cBuf_Addtext_ = 0x5B1A7C,//1.07
 R_RegisterFont_ = 0x4012B4,//1.07
 Material_RegisterHandle_ = 0x040A27C,//1.07
 R_AddCmdDrawTextInternal_ = 0x0411E18,//1.07
 R_AddCmdDrawStretchPicInternal_ = 0x04119C8,//1.07
 cgarray = 0xF57BF4,//1.07
 Health = 0x360,
 Key_IsDown = 0x1196814 + 0x0F,//1.07
 R_SetFrameFog = 0x3D0B28,//1.07 
 Entry_Stats = 0x37EEC1C7, //1.07
};
